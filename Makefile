...
generate: $(CONTROLLER_GEN)
	...
	$(CONTROLLER_GEN) rbac:roleName=virt-disk-manager-role crd webhook paths="./..." output:crd:artifacts:config=config/crd/bases
...
bundle: $(KBLD) bundle/virt-disk-operator.yaml

bundle/virt-disk-operator.yaml: $(KBLD) generate
	-mkdir -p bundle
	$(KBLD) -f config > $@
