...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VirtualDiskLVMSpec) DeepCopyInto(out *VirtualDiskLVMSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VirtualDiskLVMSpec.
func (in *VirtualDiskLVMSpec) DeepCopy() *VirtualDiskLVMSpec {
	if in == nil {
		return nil
	}
	out := new(VirtualDiskLVMSpec)
	in.DeepCopyInto(out)
	return out
}
